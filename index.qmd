...
## Motivation
Yellow taxis are a crucial component of the transportation system in New York City (NYC). The decision to delve into the analysis of **NYC Yellow Taxi Trip** data for 2014 is driven by the desire to highlight patterns and trends that may offer valuable insights into the dynamics of yellow taxi usage, fare distribution, and passenger behaviors throughout 2014.

In 2014, across the months, the total number of trips is approximately uniform. Therefore, we focus on **November 2014**, a month with exciting holidays and events in NYC. November 2014 featured several notable holidays and events:
...
This study serves as a gateway to understanding the complexity of NYC transportation patterns, particularly in November 2014. Through this exploration, we aim to highlight various aspects of the NYC yellow taxi system by comparing and contrasting the dynamics of yellow taxi usage, fare distribution, and passenger behaviors on holidays and event days with those on regular days.


## Research Question
1. What is the trend in the number of trips in November 2014 by day?
* Do weekends/holidays in the chosen month impact the number of trips?
...
* Is there a relationship between fare amounts and time of the day, trip distance, or trip duration?

3. NYC Yellow Taxi Tipping Trend:
* How does the average tip amount vary throughout the day (hourly) and across different weekdays (daily), providing insights into tipping patterns in NYC?
...
* **NYC Marathon (November 2, 2014)**: The New York City Marathon is one of the world's largest marathons, with thousands of participants running through all five boroughs of the city. The event attracts runners from around the globe and is a major highlight for both participants and spectators.
