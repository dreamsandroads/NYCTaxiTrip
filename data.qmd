...
Given the NYC border longitudes and latitudes, there are 255,952 rows with incorrect geographic locations. We removed those rows.
...
Nevertheless, all NA values from the data seem to have already been replaced with 0s (refer back to scatter plot in **2.1 data description** shown zero-distance trips with non-zero total amount).
